...
public class PathsenseGeofenceDemoNotificationFactory extends PathsenseNotificationFactory {
    ...
    private NotificationChannel getNotificationChannel(Context context) {
        ...
        String notificationChannelId = "pathsense-geofence-demo-2020";
        NotificationChannel notificationChannel = notificationManager.getNotificationChannel(notificationChannelId);
        if (notificationChannel == null) {
            String notificationChannelName = "pathsense-geofencedemo-app";
